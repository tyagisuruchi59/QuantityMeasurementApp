...
{
// Service class used for equality comparisons
QuantityMeasurementService service = new QuantityMeasurementService();

        // Controls the program loop
        bool running = true;
    ...
    // Helper method to display all available length units
    ...
    // UC1 - Compare two values in feet
    ...
    // UC2 - Compare two values in inches
    ...
    // UC3 + UC4 - Compare quantities with different units
    static void CompareGeneric(QuantityMeasurementService service)
    {
        ...
        LengthUnit unit1 =
            Enum.Parse<LengthUnit>(Console.ReadLine()!.ToUpper());
    ...
    // UC5 - Convert from one length unit to another
    ...
    // UC6 - Add two lengths and return result in default unit
    ...
    // UC7 - Add two lengths but convert result into a target unit
    ...
    // UC8 - Convert using refactored method inside QuantityLength
    ...
    // UC13 - Demonstrates DRY arithmetic operations
